...
class ExperimentVOT(object):
    r"""Experiment pipeline and evaluation evaluation for VOT dataset.

    Notes:
        - The tracking results of three types of experiments ``supervised``
            ``unsupervised`` and ``realtime`` are compatible with the official
            VOT evaluation <https://github.com/votchallenge/vot-toolkit/>`.
    ...
    def __init__(self, root_dir, version=2017,
                 ...
                 result_dir='results', report_dir='reports', download=True):
        ...
        self.dataset = VOT(
            ...
            download=download, return_meta=True, list_file=list_file)
