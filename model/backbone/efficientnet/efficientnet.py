...
from model.backbone.efficientnet.modules import (
    round_filters,
    round_repeats,
    drop_connect,
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, use_features=[]):
        super().__init__()
    ...
    # @classmethod
    # def from_pretrained(cls, model_name, use_features, num_classes=1000, in_channels=3, strides=(1, 2, 2, 2, 2, 2, 2)):
    #     model = cls.from_name(model_name, use_features, strides, override_params={
...
if __name__ == '__main__':
    model = EfficientNet.from_name('efficientnet-b0', list(range(0, 7)), strides=(1, 2, 2, 1, 1, 1, 1))
